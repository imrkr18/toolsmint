...
export default function PercentageCalculatorClient() {
  ...
  const boxStyle = { background: 'var(--bg-elevated)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '24px', marginBottom: '20px' };
  const resStyle = { marginTop: '16px', padding: '14px 18px', background: 'var(--brand-glow)', border: '1px solid rgba(0,200,150,0.25)', borderRadius: 'var(--radius-md)', fontWeight: 700, color: 'var(--brand)', fontSize: '1.1rem' };
      ...
      <div className="page-wrapper">
        <main className="tool-page">
          <div className="tool-container">
            ...
            {/* Calc 1 */}
            <div style={boxStyle}>
              <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.05rem', fontWeight: 700, marginBottom: '16px' }}>
              ...
              {r1 && <div style={resStyle} aria-live="polite">{p1}% of {n1} = <strong>{r1}</strong></div>}
            </div>
            ...
            <div style={boxStyle}>
              ...
              {r2 && <div style={resStyle} aria-live="polite">{n2} is <strong>{r2}%</strong> of {total2}</div>}
            </div>
            ...
            <div style={boxStyle}>
              ...
              {r3 !== '' && (
                <div style={{ ...resStyle, color: isIncrease ? 'var(--success)' : 'var(--error)', borderColor: isIncrease ? 'rgba(0,200,150,0.25)' : 'rgba(239,68,68,0.25)', background: isIncrease ? 'var(--brand-glow)' : 'rgba(239,68,68,0.1)' }} aria-live="polite">
